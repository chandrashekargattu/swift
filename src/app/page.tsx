    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 to-purple-700 text-white">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-full inline-flex items-center px-4 py-2 mb-6">
              <span className="text-yellow-300 text-sm font-semibold">✨ NEW FEATURE</span>
            </div>
            <h2 className="text-4xl font-bold mb-6">
              Introducing Social Carpooling
            </h2>
            <p className="text-xl mb-8 opacity-95">
              Match with verified co-travelers on your route. Share costs, reduce carbon footprint, and make new connections!
            </p>
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <Users className="w-12 h-12 mb-4 mx-auto text-yellow-300" />
                <h3 className="text-lg font-semibold mb-2">Verified Profiles</h3>
                <p className="text-sm opacity-90">LinkedIn & ID verified travelers</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <DollarSign className="w-12 h-12 mb-4 mx-auto text-green-300" />
                <h3 className="text-lg font-semibold mb-2">Save 50-70%</h3>
                <p className="text-sm opacity-90">Split costs with co-travelers</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                <Shield className="w-12 h-12 mb-4 mx-auto text-blue-300" />
                <h3 className="text-lg font-semibold mb-2">Safe & Secure</h3>
                <p className="text-sm opacity-90">AI-powered matching algorithm</p>
              </div>
            </div>
            <Link href="/carpool" className="inline-flex items-center space-x-2 bg-white text-blue-600 px-8 py-4 rounded-full hover:shadow-xl transition-all text-lg font-semibold">
              <span>Explore Carpooling</span>
